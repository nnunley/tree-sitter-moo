...
tree-sitter-moo.wasm: $(SRC_DIR)/grammar.json
	$(TS) build -w

playground: tree-sitter-moo.wasm
	$(TS) playground

clean:
	$(RM) $(OBJS) $(LANGUAGE_NAME).pc lib$(LANGUAGE_NAME).a lib$(LANGUAGE_NAME).$(SOEXT) tree-sitter-moo.wasm
